...
object MessageFlag extends Enum[MessageFlag] {
  ...
  implicit val messageFlagDecoder: Decoder[List[MessageFlag]] = BitFlag.decoder(MessageFlag)
  implicit val messageFlagEncoder: Encoder[List[MessageFlag]] = BitFlag.encoder
}
